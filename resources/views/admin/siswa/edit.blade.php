  ...
  <div class="col-md-12">
    <div class="card mb-4">
      <div class="col-lg-10 mx-auto">
        ...
        <div class="card-body">
          <form id="wizardForm" action="{{ route('admin.siswa.update', $siswa->id) }}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="wizard-step" data-step="1">
              ...
              <div class="d-flex align-items-start align-items-sm-center gap-4 mb-4">
                <img
                  id="photoPreview"
                  src="{{ $siswa->photo ? asset('storage/'.$siswa->photo) : asset('assets/img/avatars/1.png') }}"
                  alt="user-avatar"
                ...
                <div class="button-wrapper">
                  <label for="upload" class="btn btn-primary me-2 mb-2" tabindex="0">
                    <span class="d-none d-sm-inline">Ganti Foto</span>
              ...
              <div class="row">
                <div class="mb-3 col-md-6">
                  ...
                  <input id="nis" type="text" name="nis" class="form-control"
                ...
                <div class="mb-3 col-md-6">
                  ...
                  <select id="jenis_kelamin" name="jenis_kelamin" class="form-select">
                    ...
                    <option value="" {{ $jk==''?'selected':'' }}>-- Pilih --</option>
                ...
                <div class="mb-3 col-md-6">
                  ...
                  <select id="agama" name="agama" class="form-select">
                    <option value="" {{ $ag==''?'selected':'' }}>-- Pilih --</option>
                ...
                <div class="mb-3 col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <input id="kontak" type="text" name="kontak" class="form-control" placeholder="812 3456 7890"
                ...
                <div class="mb-3 col-md-6">
                  ...
                  <select id="classroom_id" name="classroom_id" class="form-select select2" required>
                    ...
                    {{ (string)old('classroom_id', $siswa->classroom_id) === (string)$data->id ? 'selected' : '' }}>
                    {{ $data->nama_kelas }}
                  </option>
                  @endforeach
                </select>
            ...
            <div class="wizard-step d-none" data-step="2">
              <h5 class="mb-4">2. Data Orang Tua/Wali</h5>

              <div class="row">
                <div class="mb-3 col-md-6">
                  <label class="form-label" for="nama_ayah">Nama Ayah</label>
                  <input id="nama_ayah" type="text" name="nama_ayah" class="form-control"
                         value="{{ old('nama_ayah', $siswa->nama_ayah) }}">
                </div>
                <div class="mb-3 col-md-6">
                  <label class="form-label" for="nama_ibu">Nama Ibu</label>
                  <input id="nama_ibu" type="text" name="nama_ibu" class="form-control"
                ...
                <div class="mb-3 col-md-6">
                  ...
                  <div class="input-group">
                    <span class="input-group-text">+62</span>
                    <input id="kontak_ayah" type="text" name="kontak_ayah" class="form-control" placeholder="812 3456 7890"
                           value="{{ old('kontak_ayah', $siswa->kontak_ayah) }}">
                  </div>
                </div>
                <div class="mb-3 col-md-6">
                  ...
                  <div class="input-group">
                    <span class="input-group-text">+62</span>
                    <input id="kontak_ibu" type="text" name="kontak_ibu" class="form-control" placeholder="812 3456 7890"
                           value="{{ old('kontak_ibu', $siswa->kontak_ibu) }}">
                  </div>
                </div>
                <div class="mb-3 col-md-6">
                  <label class="form-label" for="nama_wali_murid">Nama Wali Murid</label>
                  <input id="nama_wali_murid" type="text" name="nama_wali_murid" class="form-control"
                         value="{{ old('nama_wali_murid', $siswa->nama_wali_murid) }}">
                </div>
                <div class="mb-3 col-md-6">
                  <label class="form-label" for="kontak_wali">Nomor Telepon / Whatsapp Wali</label>
                  <div class="input-group">
                    <span class="input-group-text">+62</span>
                    <input id="kontak_wali" type="text" name="kontak_wali" class="form-control" placeholder="812 3456 7890"
                           value="{{ old('kontak_wali', $siswa->kontak_wali) }}">
                  </div>
                </div>
                <div class="mb-3 col-md-6">
